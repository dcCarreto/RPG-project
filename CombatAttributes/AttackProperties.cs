namespace Base
{
    public class Attack
    {
        ...
        public Attack(AttackList atkName, DamageTypes types, RangeTypes range, string dice,
                      int toHitBonus = 0, int reach = 0, DamageTypes element = 0, string diceDamageOnFail = "", int acidSaveDC = 0, AttributeName attributeSave = 0)
        {
            Random rd = new();
            AtkName = atkName;
            Types = types;
            ...
            DamageOnFail = CombatBase.RollDice(diceDamageOnFail);
